package xyz.Extencion.extencion.utils.movement;
...
import xyz.Extencion.extencion.QuickImports;
...
public class MovingUtil implements QuickImports {
    ...
    public static class DirectionalInput {
        ...
        public DirectionalInput(Input input) {
            // Fix: Use the correct methods to access input states
            this(input.movementForward > 0,      // forward
                    input.movementForward < 0,      // backward
                    input.movementSideways < 0,     // left
                    input.movementSideways > 0);    // right
        }
